      ...
      <?php foreach ($user as $key => $value) { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group">
                   <label for="">Nama User</label>
                  <input name="nama_user" class="form-control" $value="['id_user'])?>" placeholder="Nama User" required>
              </div>

              <div class="form-group">
                   <label for="">E-mail</label>
                  <input name="email" class="form-control" $value="['email'])?>" placeholder="E-mail" required>
              </div>

              <div class="form-group">
                   <label for="">Password</label>
                  <input name="password" class="form-control" $value="['password'])?>" placeholder="Password" readonly>
              </div>
      ...
      <?php foreach ($user as $key => $value) { ?>
        ...
        <div class="modal-dialog">
          ...
          Apakah Anda Yakin Hapus <b><?= $value['nama_user'] ?></b> ..?
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
               <a href="<?= base_url('User/HapusData/' . $value['id_user']) ?>" class="btn btn-danger btn-flat">Delete</a>
            </div>
