...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('AdminLte')?>/plugins/fontawesome-free/css/all.min.css">
   ...
   <!-- DataTables -->
   <link rel="stylesheet" href="<?= base_url('AdminLTE') ?>/plugins/datatables-bs4/css/dataTables.boostrap4.min.css">
  <link rel="stylesheet" href="<?= base_url('AdminLTE') ?>/plugins/datatables-responsive/css/responsive.boostrap4.min.css">
  <link rel="stylesheet" href="<?= base_url('AdminLTE') ?>/plugins/datatables-buttons/css/buttons.boostrap4.min.css">
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-pink">
    <div class="container">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <label class="form-control form-control-lg text-blue"><?= $no_faktur?></label>
                </div>
                </div>
          ...
          <div class="col-lg-5">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-black color-palette text-right">
                  <label class="display-4 text-blue">Rp. <?= number_format($grand_total,0) ?>.-</h1>
              </div>
            </div>
          </div>
  ...
  <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-black color-palette text-center">
                  <h1 class=" text-blue" id="terbilang"></h1>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><?= $value['stok'] ?></td>
                      <td><button onclick="PilihProduk(<?= $value['kode_produk'] ?>)" class="btn btn-success btn-xs">Pilih</button></td>
                    </tr>
                 <?php  } ?>
                </tbody>
              </table>
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            Swal.fire('Kode Produk Tidak terdaftar!!');
              ...
              $('[name="nama_satuan"]').val(response.nama_kategori);
